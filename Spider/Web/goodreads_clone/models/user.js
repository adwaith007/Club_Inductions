...
var userSchema = new Schema({
    ...
    privacyType: {type:String, default: "Public"},
    bookshelf: [{
        book: {type: Schema.Types.ObjectId, ref: "Book"},
        currentstatus: {type: String, default: "Just a book in my shelf"}
    }],
    reviews:[{type: Schema.Types.ObjectId, ref: "Review"}],
    booklikes:[{type:Schema.Types.ObjectId, ref:"Book"}],
    reviewlikes:[{type: Schema.Types.ObjectId, ref:"Review"}],
    favourites:[{type:Schema.Types.ObjectId, ref:"Book"}],
    followers:[{type: Schema.Types.ObjectId, ref: "User"}],
    following:[{type: Schema.Types.ObjectId, ref: "User"}],
    requesti: [{type: Schema.Types.ObjectId, ref:"Request"}],
    requesto: [{type: Schema.Types.ObjectId, ref:"Request"}],
